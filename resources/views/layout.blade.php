...
<div class="wrapper" >
  ...
  <aside class="main-sidebar  elevation-4"  style="background-color:#273746">
    ...
    <a href="#" class="brand-link">
      <img src="/img/marina.jpeg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview ">
            ...
            <ul class="nav nav-treeview">   
              ...
              <li class="nav-item">
                <a href="{{route('credencial.create')}}" class="nav-link px-4" >
                  <i class="fas fa-id-badge nav-icon"></i>
                  <p>Credencial Mercante</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('carnets.create')}}" class="nav-link px-4" >
