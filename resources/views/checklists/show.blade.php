	...
	<div style="overflow-x:auto;" class="mx-auto mb-3 bg-white shadow rounded py-3 px-4">
		...
		<div class="container col-md-12">
			...
			@elseif($files->clase_tipo == 'BOTE/DESLIZADOR')
				@include('checklists.vistas.botedeslizador')
			@elseif($files->clase_tipo == 'BOTE')
				@include('checklists.vistas.botedeslizador')
			@elseif($files->clase_tipo == 'DESLIZADOR')
				@include('checklists.vistas.botedeslizador')
			@elseif($files->clase_tipo == 'BARCAZA ABIERTA')
				@include('checklists.vistas.bmade')
			@elseif($files->clase_tipo == 'CATAMARAN')
				@include('checklists.vistas.bmade')
			@elseif($files->clase_tipo == 'ALISCAFO')
				@include('checklists.vistas.botedeslizador')
