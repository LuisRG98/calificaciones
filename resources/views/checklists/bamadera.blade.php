    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[16][key]" class="form-control" value="16">
	      <div class="col-md-4"> <label>MANGUERAS DE INCENDIO COMPLETAS CON PITÓN DOSIFICADOR. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[17][key]" class="form-control" value="17">
	      <div class="col-md-4"> <label>EXTINTORES (UNO DE 12 KG, UNO DE 6 KG). (EO)</label></div>
