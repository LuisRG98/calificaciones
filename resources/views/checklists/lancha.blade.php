    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[4][key]" class="form-control" value="4">
	      <div class="col-md-4"> <label>EL PATRÓN TIENE CARNET DE TRIPULANTE. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[5][key]" class="form-control" value="5">
	      <div class="col-md-4"> <label>LIBRO DE REGISTRO DE DESCARGA DE BASURA. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[6][key]" class="form-control" value="6">
	      <div class="col-md-4"> <label>TIENE REMOS ADECUADOS. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[7][key]" class="form-control" value="7">
	      <div class="col-md-4"> <label>TIENE SINGA A BORDO. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="m[12][key]" class="form-control" value="12">
	      <div class="col-md-4"> <label>PINTADO DE LÍNEA DE AGUA. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="m[13][key]" class="form-control" value="13">
	      <div class="col-md-4"> <label>LUCES DE NAVEGACIÓN (BANDAS, TOPE, POPA) (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[16][key]" class="form-control" value="16">
	      <div class="col-md-4"> <label>CARTELERÍA RESTRICTIVA. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[18][key]" class="form-control" value="18">
	      <div class="col-md-4"> <label>EXTINTORES (DOS DE 6 KG)-APROBADA SEGÚN NORMA NFPA 10. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[22][key]" class="form-control" value="22">
	      <div class="col-md-4"> <label>PINTADO DEL CASCO EN BUEN ESTADO (INTERIOR Y EXTERIOR). (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[28][key]" class="form-control" value="28">
	      <div class="col-md-4"> <label>CALAFATEADO EN BUEN ESTADO. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[29][key]" class="form-control" value="29">
	      <div class="col-md-4"> <label>BANCADAS ADECUADAS PARA TRANSPORTAR PASAJEROS. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[30][key]" class="form-control" value="30">
	      <div class="col-md-4"> <label>CUENTA CON ENJARETADO. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[31][key]" class="form-control" value="31">
	      <div class="col-md-4"> <label>CUENTA CON BASUREROS A BORDO (MÍNIMO DOS). (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[32][key]" class="form-control" value="32">
	      <div class="col-md-4"> <label>INDUMENTARIA ADECUADA DEL PATRÓN (OVEROL, BOTAS DE SEGURIDAD, GUANTES, GAFAS,, SUPRESOR DE RUIDO). (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[36][key]" class="form-control" value="36">
	      <div class="col-md-4"> <label>TANQUE DE HERRAMIENTAS. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[37][key]" class="form-control" value="37">
	      <div class="col-md-4"> <label>MANGUERAS DE COMBUSTIBLE. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[38][key]" class="form-control" value="38">
	      <div class="col-md-4"> <label>CONMUTADOR. (EO)</label></div>
