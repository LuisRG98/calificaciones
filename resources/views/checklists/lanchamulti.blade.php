    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="m[4][key]" class="form-control" value="4">
	      <div class="col-md-4"> <label>CERTIFICADO DE PREVENCIÓN DE LA CONTAMINACIÓN DEL MEDIO AMBIENTE ACUÁTICO VIGENTE. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[7][key]" class="form-control" value="7">
	      <div class="col-md-4"> <label>LIBRO REGISTRO DE BASURA. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[12][key]" class="form-control" value="12">
	      <div class="col-md-4"> <label>CODIGO INTERNACIONAL DE SEÑALES. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[16][key]" class="form-control" value="16">
	      <div class="col-md-4"> <label>COMPÁS MAGNÉTICO. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[23][key]" class="form-control" value="23">
	      <div class="col-md-4"> <label>MEGÁFONO PORTÁTIL. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[28][key]" class="form-control" value="28">
	      <div class="col-md-4"> <label>PINTADO DE LAS MARCAS DE FRANCOBORDO. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[36][key]" class="form-control" value="36">
	      <div class="col-md-4"> <label>MANGUERA DE LUCHA CONTRA INCENDIOS COMPLETA (CON PITÓN DOSIFICADOR DE AGUA A CHORRO Y NIEBLA). (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[37][key]" class="form-control" value="37">
	      <div class="col-md-4"> <label>EXTINTORES DE INCENDIO (DOS DE 12 KG Y DOS DE 6 KG). (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[39][key]" class="form-control" value="39">
	      <div class="col-md-4"> <label>CABOS DE REMOLQUE. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[54][key]" class="form-control" value="54">
	      <div class="col-md-4"> <label>LIBRE DE FUGAS DE COMBUSTIBLE/LIQUIDO HIDRÁULICO/ACEITES. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[62][key]" class="form-control" value="62">
	      <div class="col-md-4"> <label>PANEL DE INSTRUMENTOS (MAQUINA PRINCIPAL). (EO)</label></div>
