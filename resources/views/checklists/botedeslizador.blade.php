    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[4][key]" class="form-control" value="4">
	      <div class="col-md-4"> <label>EL PATRÓN TIENE CARNET DE TRIPULANTE VIGENTE. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[6][key]" class="form-control" value="6">
	      <div class="col-md-4"> <label>TIENE SINGA. (ER)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[8][key]" class="form-control" value="8">
	      <div class="col-md-4"> <label>TIENE PABELLÓN NACIONAL (VERIFICAR LAS CONDICIONES). (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="m[10][key]" class="form-control" value="10">
	      <div class="col-md-4"> <label>LUCES DE NAVEGACIÓN (BANDAS). (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[13][key]" class="form-control" value="13">
	      <div class="col-md-4"> <label>BOMBA DE ACHIQUE/ACHICADOR MANUAL. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[15][key]" class="form-control" value="15">
	      <div class="col-md-4"> <label>BOMBA ACHIQUE/ACHICADOR. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="m[16][key]" class="form-control" value="16">
	      <div class="col-md-4"> <label>EXTINTOR (UNO DE 6KG). (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[20][key]" class="form-control" value="20">
	      <div class="col-md-4"> <label>MOTOR PRINCIPAL EN BUEN ESTADO. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[22][key]" class="form-control" value="22">
	      <div class="col-md-4"> <label>PIEZAS DE RECAMBIO MÍNIMOS. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[25][key]" class="form-control" value="25">
	      <div class="col-md-4"> <label>MAMPAROS EN BUEN ESTADO LIBRE DE FISURAS. (EO)</label></div>
	    ...
	    <input hidden="hidden" type="text" name="d[28][key]" class="form-control" value="28">
	      <div class="col-md-4"> <label>PROTECCIÓN PERSONAL BARANDILLAS. (EO)</label></div>
    ...
    <hr>
  	<div class="container col-md-12">
	    ...
	    <input hidden="hidden" type="text" name="d[33][key]" class="form-control" value="33">
	      <div class="col-md-4"> <label>INDUMENTARIA ADECUADA DEL PATRÓN (OVEROL, BOTAS DE SEGURIDAD, GUANTES, GAFAS, CASCO, BARBIJO, SUPRESOR DE RUIDO). (EO)</label></div>
