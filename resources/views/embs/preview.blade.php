...
<div class="container">
	<div style="overflow-x:auto;" class="mx-auto mb-3">
		<form class="bg-white shadow rounded py-3 px-4" method="POST" action="{{route('embprev.store')}}">
			@csrf
			...
			<div class="alert alert-danger" role="alert">
			  Si los campos obligatorios no son llenados correctamente se redirigirá a este formulario
			</div>
