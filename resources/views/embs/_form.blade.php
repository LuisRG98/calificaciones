...
<div class="form-group col-md-12 required">
	...
	<div class="col-md-2">
		...
		<input
			class="form-control bg-light shadow-sm 	@error('cuenca') is-invalid @enderror border-1"
			type="hidden"
			name="cuenca"
			id="cuenca"
			value="{{old('cuenca',$emb->cuenca ?? $cuen ??'')}}">
...
<div class="form-group col-md-12">
	...
	<div class="col-md-3">
		...
		<select
			...
			<option value="BARCAZA ABIERTA DE MADERA" {{ old('clase_tipo',  $emb->clase_tipo) == 'BARCAZA ABIERTA DE MADERA' ? 'selected' : '' }}>BARCAZA ABIERTA DE MADERA</option>
